...
ECIES.prototype.encryptBLS = function(bls, message, ivbuf) {
	...
	const c = AESCBC.encryptCipherkey(message, KDF_kE(bls, this._blsSecretKey, this._blsPublicKey), ivbuf);
	const d = Hash.sha256hmac(c, KDF_kM(bls, this._blsSecretKey, this._blsPublicKey));
	if(this.opts.shortTag) d = d.slice(0,4);
	let encbuf;
	if(this.opts.noKey) {
...
ECIES.prototype.decryptBLS = function(bls, encbuf) {
  ...
  */
	...
	var d2 = Hash.sha256hmac(c, KDF_kM(bls, this._blsSecretKey, this._blsPublicKey));
	if(this.opts.shortTag) d2 = d2.slice(0,4);
	...
	return AESCBC.decryptCipherkey(c, KDF_kE(bls, this._blsSecretKey, this._blsPublicKey));
};
